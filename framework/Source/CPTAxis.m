...
@property (nonatomic, readwrite, weak) __weak CPTGridLines *minorGridLines;
@property (nonatomic, readwrite, weak) __weak CPTGridLines *majorGridLines;
@property (nonatomic, readwrite, weak) __weak CPTAxisLabel *pointingDeviceDownLabel;
@property (nonatomic, readwrite, weak) __weak CPTAxisLabel *pointingDeviceDownTickLabel;
...
/** @property __weak CPTPlotArea *plotArea
 *  @brief The plot area that the axis belongs to.
 **/
@synthesize plotArea;

/** @property __weak CPTGridLines *minorGridLines
 *  @brief The layer that draws the minor grid lines.
 **/
@synthesize minorGridLines;

/** @property __weak CPTGridLines *majorGridLines
...
/** @internal
 *  @property __weak CPTAxisLabel *pointingDeviceDownLabel
 *  @brief The label that was selected on the pointing device down event.
 **/
@synthesize pointingDeviceDownLabel;

/** @internal
 *  @property __weak CPTAxisLabel *pointingDeviceDownTickLabel
